...
export interface ApiAccountActionAccountAction extends Struct.CollectionTypeSchema {
  collectionName: "account_actions";
  info: {
    displayName: "Account actions";
    pluralName: "account-actions";
    singularName: "account-action";
  };
  options: {
  ...
  attributes: {
    action: Schema.Attribute.Enumeration<
      ["block_user", "unblock_user", "delete_user", "disable_org", "enable_org"]
    >;
    applied_at: Schema.Attribute.Date;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::account-action.account-action"> &
      Schema.Attribute.Private;
    meta_data: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    reason: Schema.Attribute.String;
    status_user: Schema.Attribute.Enumeration<["pending", "applied", "failed"]>;
    target_id: Schema.Attribute.String;
    target_type: Schema.Attribute.Enumeration<["user", "organization"]>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
}
...
export interface ApiCdcTemplateCdcTemplate extends Struct.CollectionTypeSchema {
  collectionName: "cdc_templates";
  info: {
    displayName: "CDC template";
    pluralName: "cdc-templates";
    singularName: "cdc-template";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::cdc-template.cdc-template"> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFaqEntryFaqEntry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    is_active: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::faq-entry.faq-entry"> &
      Schema.Attribute.Private;
...
export interface ApiFeatureFlagFeatureFlag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::feature-flag.feature-flag"> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOkrTemplateOkrTemplate extends Struct.CollectionTypeSchema {
  collectionName: "okr_templates";
  info: {
    displayName: "OKR templates";
    pluralName: "okr-templates";
    singularName: "okr-template";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    key: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::okr-template.okr-template"> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    objective_types: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    tree_defaults: Schema.Attribute.JSON & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
}

export interface ApiOnboardingStepOnboardingStep extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    key: Schema.Attribute.String & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::onboarding-step.onboarding-step"> &
      Schema.Attribute.Private;
    module: Schema.Attribute.Enumeration<
      [
        "crm",
...
export interface ApiPricingPagePricingPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::pricing-page.pricing-page"> &
      Schema.Attribute.Private;
    plans_highlights: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
...
export interface ApiResourceTemplateResourceTemplate extends Struct.CollectionTypeSchema {
  collectionName: "resource_templates";
  info: {
    displayName: "Resource templates";
    pluralName: "resource-templates";
    singularName: "resource-template";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    daily_cost: Schema.Attribute.Decimal;
    daily_rate: Schema.Attribute.Integer;
    is_active: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    key: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    ...
    localizations: Schema.Attribute.Relation<
      "oneToMany",
      "api::resource-template.resource-template"
    > &
      Schema.Attribute.Private;
    meta_data: Schema.Attribute.JSON;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<["PM", "Dev", "Design", "QA"]> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
}

export interface ApiRoadmapTemplateRoadmapTemplate extends Struct.CollectionTypeSchema {
  collectionName: "roadmap_templates";
  info: {
    displayName: "Roadmap template";
    pluralName: "roadmap-templates";
    singularName: "roadmap-template";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    default_view: Schema.Attribute.Enumeration<["gantt", "phases", "outcomes"]> &
      Schema.Attribute.Required;
    description: Schema.Attribute.String;
    is_active: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
    ...
    localizations: Schema.Attribute.Relation<
      "oneToMany",
      "api::roadmap-template.roadmap-template"
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    view_defaults: Schema.Attribute.JSON & Schema.Attribute.Required;
  };
}
...
declare module "@strapi/strapi" {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      "api::account-action.account-action": ApiAccountActionAccountAction;
      "api::article.article": ApiArticleArticle;
      "api::author.author": ApiAuthorAuthor;
      "api::category.category": ApiCategoryCategory;
      "api::cdc-template.cdc-template": ApiCdcTemplateCdcTemplate;
      "api::config.config": ApiConfigConfig;
      "api::faq-entry.faq-entry": ApiFaqEntryFaqEntry;
      "api::feature-flag.feature-flag": ApiFeatureFlagFeatureFlag;
      "api::global.global": ApiGlobalGlobal;
      "api::okr-template.okr-template": ApiOkrTemplateOkrTemplate;
      ...
      "api::resource-template.resource-template": ApiResourceTemplateResourceTemplate;
      "api::roadmap-template.roadmap-template": ApiRoadmapTemplateRoadmapTemplate;
